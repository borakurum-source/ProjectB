        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-8 space-y-10 print:p-0 print:overflow-visible text-[#111827] dark:text-[#F8FAFC]">
          ...
          {reportFormat === 'document' && (
            <div className="space-y-12 print:space-y-0">
              ...
              {/* PAGE 3: BRAND MENTIONS & SHARE OF VOICE */}
                ...
                <div className="report-page bg-white dark:bg-[#0F172A] border border-[#E2E8F0] dark:border-[#1E293B] p-8 sm:p-10 rounded-lg shadow-sm print:border-none print:shadow-none print:p-8 page-break-after">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-xs sm:text-sm text-[#64748B] dark:text-[#94A3B8] mt-1">
                        Brands ordered by observed mention count across the tracked run cycle; this is a display order, not a model answer rank.
                      </p>
                    </div>
                ...
                <div className="report-page bg-white dark:bg-[#0F172A] border border-[#E2E8F0] dark:border-[#1E293B] p-8 sm:p-10 rounded-lg shadow-sm print:border-none print:shadow-none print:p-8 page-break-after">
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-xs sm:text-sm text-[#64748B] dark:text-[#94A3B8] mt-1">
                        Observed brand mentions, coverage and share of voice across the selected Gemini Grounded runs. No rank or likelihood is inferred from prose.
                      </p>
                    </div>
                    ...
                    <div className="border border-[#E2E8F0] dark:border-[#1E293B] rounded-lg overflow-hidden">
                      <table className="w-full text-xs text-left">
                        <thead className="bg-[#F8FAFC] dark:bg-[#1E293B] border-b border-[#E2E8F0] dark:border-[#334155] text-[#64748B] dark:text-[#94A3B8] uppercase text-[10px] font-bold">
                          <tr><th className="py-3 px-3">Brand</th><th className="py-3 px-3 text-center">Mentions</th><th className="py-3 px-3 text-center">Coverage</th><th className="py-3 px-3 text-center">Share of Voice</th><th className="py-3 px-3 text-center">Sentiment</th></tr>
                        </thead>
                        <tbody className="divide-y divide-[#E2E8F0] dark:divide-[#1E293B]">
                          {reportData.brandRanking.map((b) => (
                            <tr key={b.brand} className={b.isClient ? 'bg-emerald-50/60 dark:bg-emerald-950/20 font-semibold' : ''}>
                              <td className="py-2.5 px-3">{b.brand}{b.isClient && <span className="ml-2 px-1.5 py-0.5 text-[9px] bg-emerald-600 text-white rounded font-bold uppercase">Your Brand</span>}</td>
                              <td className="py-2.5 px-3 text-center font-mono">{b.mentions}</td>
                              <td className="py-2.5 px-3 text-center font-mono">{b.brandCoverage}% (n={reportData.sampleSize})</td>
                              <td className="py-2.5 px-3 text-center font-mono">{b.shareOfVoice}%</td>
                              <td className="py-2.5 px-3 text-center font-mono">{b.sentimentLabel}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
            ...
            <div className="max-w-5xl mx-auto w-full">
              ...
              <div className="bg-white dark:bg-[#0F172A] border border-[#E2E8F0] dark:border-[#1E293B] rounded-2xl shadow-xl p-8 sm:p-12 min-h-[540px] flex flex-col justify-between relative overflow-hidden transition-all duration-300">
                ...
                {currentSlide === 2 && (
                  <div className="h-full flex flex-col justify-between flex-1 space-y-4">
                    <SlideHeader
                      title="Brand Mentions & Share of Voice"
                      subtitle="Display order by observed mentions; no prose rank inferred"
                      slideNumber={3}
                      totalSlides={totalSlideCount}
                    />
                ...
                {/* Slide 5: Brand Visibility Table */}
                {currentSlide === 4 && (
                  <div className="h-full flex flex-col justify-between flex-1 space-y-4">
                    <SlideHeader
                      title="Brand Visibility Table"
                      subtitle="Observed mention coverage and share of voice; no prose rank inferred"
                      slideNumber={5}
                      totalSlides={totalSlideCount}
                    />
                    <div className="border border-slate-200 dark:border-slate-800 rounded-lg overflow-hidden my-auto">
                      <table className="w-full text-xs text-left">
                        <thead className="bg-slate-50 dark:bg-slate-800 text-[10px] uppercase font-bold text-slate-500"><tr><th className="py-2.5 px-3">Brand</th><th className="py-2.5 px-3 text-center">Mentions</th><th className="py-2.5 px-3 text-center">Coverage</th><th className="py-2.5 px-3 text-center">Share of Voice</th></tr></thead>
                        <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
                          {reportData.brandRanking.slice(0, 8).map((b) => (
                            <tr key={b.brand} className={b.isClient ? 'bg-emerald-50/60 dark:bg-emerald-950/20 font-bold' : ''}>
                              <td className="py-2 px-3">{b.brand}</td>
                              <td className="py-2 px-3 text-center font-mono">{b.mentions}</td>
                              <td className="py-2 px-3 text-center font-mono">{b.brandCoverage}%</td>
                              <td className="py-2 px-3 text-center font-mono text-indigo-600 font-bold">{b.shareOfVoice}%</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
